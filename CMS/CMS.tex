...
\begin{figure}[ht!]
	...
	\captionof{figure}{Valeur du champ magnétique (gauche) et lignes de champs (droite) selon une couche longitudinale du détecteur CMS, prédits par la simulation. Pour une densité de flux central de 3.8T.}
	\label{CHAMP}
\end{figure}