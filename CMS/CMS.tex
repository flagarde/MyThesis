...
La mise  à niveau du LHC vers le HL-HLC prévoit de multiplier la luminosité par $10$, ce qui nécessite la mise à niveau de CMS pendant les arrêt LS2 et LS3 afin de pouvoir s'adapter à cette luminosité et au pile-up suipplémentaire que cela va engendred. Parmis les mise à niveau programmé citons :
\begin{itemize}[label=$\bullet$]
	\item 
\end{itemize}