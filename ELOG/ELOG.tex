...
\lettrine[lines=3, slope=-0.5em]{L}{e} fichier elogd.cfg utilisé par la programme Electronic Logbook (ELOG) pour la configuration du cahier de manipulation du GIF++ (logbook) est retranscrit ci-dessous :
