...
//gStyle->SetOptFit(1);
  ...
  D.addGraph(A.gr_Ich1ggJune15,"chamber 1, June 15 7 pm",0,0,A.chamber1_ColorIndex);
  D.addGraph(A.gr_Ich1maxJune15,a.Data(),2300,3200,A.chamber1_ColorIndex);
  a.Form("chamber 2, June 15 11 pm; 1/R=%f +-%f",0.00208525,1.57698e-05); 
  D.addGraph(A.gr_Ich2ggJune15,"chamber 2, June 15 7 pm",0,0,A.chamber2_ColorIndex);
  D.addGraph(A.gr_Ich2maxJune15,a.Data(),1800,5200,A.chamber2_ColorIndex);
  a.Form("chamber 4, June 15 11 pm; 1/R=%f +-%f",0.0193,0.00138803);
  D.addGraph(A.gr_Ich4ggJune15,"chamber 4, June 15 7 pm",0,0,A.chamber4_ColorIndex);
  D.addGraph(A.gr_Ich4maxJune15,a.Data(),4100,5200,A.chamber4_ColorIndex);
   a.Form("chamber 5, June 15 11 pm; 1/R=%f +-%f",0.0130643,0.000539197);
  D.addGraph(A.gr_Ich5ggJune15,"chamber 5, June 15 7 pm",0,0,A.chamber5_ColorIndex);
  D.addGraph(A.gr_Ich5maxJune15,a.Data(),3600,4800,A.chamber5_ColorIndex);
  ...
  D.drawFake(2500,6);
  D.addGraph(A.gr_Ich1ggJune15,"June 15 7 pm, HV going up",0,0,0);
  D.addGraph(A.gr_Ich1ggJune16up,"June 16 11 am, HV going up",0,0,0);
  D.addGraph(A.gr_Ich1ggJune16down,"June 16 11 am, HV going down",0,0,0);
  D.finalizeCanva();

  D.beginCanva("Argon_current_chamber_2","Argon current chamber 2");
  D.drawFake(4600,6);
  D.addGraph(A.gr_Ich2ggJune15,"June 15 7 pm, HV going up",0,0,0);
  D.addGraph(A.gr_Ich2ggJune16up,"June 16 11 am, HV going up",0,0,0);
  D.addGraph(A.gr_Ich2ggJune16down,"June 16 11 am, HV going down",0,0,0);
  D.finalizeCanva();

  D.beginCanva("Argon_current_chamber_4","Argon current chamber 4");
  D.drawFake(4000,6);
  D.addGraph(A.gr_Ich4ggJune15,"June 15 7 pm, HV going up",0,0,0);
  D.addGraph(A.gr_Ich4ggJune16up,"June 16 11 am, HV going up",0,0,0);
  D.addGraph(A.gr_Ich4ggJune16down,"June 16 11 am, HV going down",0,0,0);
  D.finalizeCanva();

  D.beginCanva("Argon_current_chamber_5","Argon current chamber 5");
  D.drawFake(3400,6);
  D.addGraph(A.gr_Ich5ggJune15,"June 15 7 pm, HV going up",0,0,0);
  D.addGraph(A.gr_Ich5ggJune16up,"June 16 11 am, HV going up",0,0,0);
  D.addGraph(A.gr_Ich5ggJune16down,"June 16 11 am, HV going down",0,0,0);
  D.finalizeCanva();
