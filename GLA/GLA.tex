...
Huit chambre GRPC ont été amené au PS en Juin 2014 dans la Zone Est ( ligne de faisceau T9 ), juste avant le début de cette thèse, afin de former un télescope (cf.fig\ref{TelescopePS}).
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.9\linewidth]{GLA/HVPS.png}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.9\linewidth]{GLA/RatePS.png}
