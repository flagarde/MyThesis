...
\end{figure}
 ...
 Des scans en haute tension ont été effectués pour plusieurs valeurs de l'atténuateur de la source. Le programme d'analyse à permis de calculer l'efficacité, la taille moyenne d'un amas ("cluster size") (cf.fig\ref{clustersize}) et la probabilité de streamer comme définit précédement (cf.fig\ref{probastreamer}).
\tikzexternaldisable
\begin{figure}
	\centering
