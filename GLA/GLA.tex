...
%\begin{figure}[ht]
%	\centering
%	\subfloat[Taux de bruit par strip dans la chambre en verre de basse résistivité.]{\includegraphics[width=0.40\textwidth]{GLA/NOISEH2H.png}\label{noisH2B}} 
%	\hfill
%	\subfloat[Taux de bruit par strip dans la chambre en verre "float glass".]{\includegraphics[width=0.45\textwidth]{GLA/NOISEH2B.png}\label{noisH2H}}
