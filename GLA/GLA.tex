...
\begin{figure}[ht!]
	...
	\hfill
	\subfloat[Multiplicité en fonction du seuil.]{\scalebox{0.64}{\includetex{GLA/Mul_200_1970}}}
...
\begin{figure}[ht!]
	\centering
	\subfloat[Efficacité en fonction du seuil.]{\scalebox{0.64}{\includetex{GLA/Eff_22_1970}}}
	\hfill
	\subfloat[Multiplicité en fonction du seuil.]{\scalebox{0.64}{\includetex{GLA/Mul_22_1970}}}
	\caption{Efficacité et multiplicité en fonction du seuil appliqué pour la première chambre du télescope placée à \SI{2}{\meter} de la source. La tension appliquée est de \SI{7000}{\volt} et le facteur d'atténuation de la source est de \num{22}.}
	\label{att22}
\end{figure}
...
\begin{figure}[!ht]
	\centering
	%\scalebox{0.92}{\includetex{GLA/DIF216_LR}}
...
\begin{figure}[ht!]
	\centering
	\subfloat[Chambre 1 (verre de basse résistivité).]{\scalebox{0.92}{\includetex{GLA/Argon_current_chamber_1}}}
	\\
	\subfloat[Chambre 2 ("float glass")]{\scalebox{0.92}{\includetex{GLA/Argon_current_chamber_2}}}
...
\begin{figure}[!ht]
	\centering
	\scalebox{1.2}{\includetex{GLA/Argon_current}}
...
\begin{figure}[!ht]
	\centering
	\scalebox{1.3}{\includetex{GLA/BigChambersComparaison}}
...
\begin{figure}[ht!]
	\centering
	\subfloat[Timestamps des strips non-alignés.]{\scalebox{0.75}{\includetex{GLA/fitting_unaligned}}\label{nonalign}}
	\\
	\subfloat[Timestamps des strips alignés.]{\scalebox{0.75}{\includetex{GLA/fitting_aligned}}\label{align}}
...
\begin{figure}
\centering
\subfloat[$\epsilon_{vrai} -\epsilon_{1}$.]{\scalebox{0.75}{\includetex{GLA/biais1}}\label{biaismethod1}}
\\
\subfloat[$\epsilon_{vrai} -\epsilon_{2}$.]{\scalebox{0.75}{\includetex{GLA/biais2}}}
...
\begin{figure}
	\centering
	\scalebox{1.3}{\includetex{GLA/TimeDistryBC}}
...
\end{figure}
 ...
 \begin{figure}
 	\centering
 	\scalebox{1.3}{\includetex{GLA/SigmoidBC}}
...
\begin{figure}
	\centering
	\scalebox{1.3}{\includetex{GLA/ClusterSizeBC}}
...
\begin{figure}
	\centering
	\scalebox{1.3}{\includetex{GLA/ProbaStreamerBC}}
...
\begin{figure}[ht!]
	\centering
	\scalebox{1.2}{\includetex{GLA/CurrentRE11}}
...
\begin{figure}[ht!]
	\centering
	\subfloat[]{\scalebox{1}{\includetex{GLA/EffiNoiseChi}}\label{effi904Chi}} 
	\hfill
	\subfloat[]{\scalebox{1}{\includetex{GLA/EffiNoiseBak}}\label{effi904Bak}}
...
\begin{figure}[ht!]
	\centering
	\subfloat[Distribution du nombres de runs en fonction du nom de la configuration dans la database. \num{30} runs ont été écrit dans le mauvais elog (M3) suite à une erreur de configuration.]{\scalebox{1.3}{\includetex{GLA/hSetupName_order}}} 
	\\
	\subfloat[Corrélation entre le statut du faisceau et le statut de la source pour les \num{126} runs ayant été inscrits dans le bon elog.]{\scalebox{1.3}{\includetex{GLA/hStatusBeamVsSource}}} 
	\\
	\subfloat[Nombre de runs en fonction du seuil, l'axe $z$ est le nombre d'atténuateur de la source pour les seuils correspondant.]{\scalebox{1.3}{\includetex{GLA/hAttScanThresholdVsNrun}}}
	\\
	\subfloat[Valeur de l'atténuateur de la source en fonction du seuil, la couleur (le numéro) de l'axe $z$ représente le nombre de valeurs d'atténuateur prises (de runs pris avec cette valeur d'atténuateur).]{\scalebox{1.3}{\includetex{GLA/hAttScanThresholdVsAtt}}}
