...
\begin{figure}[ht!]
	...
	\hfill
	\subfloat[Corrélation entre le statut du faisceau et le statut de la source pour les \num{126} runs ayant été inscrits dans le bon elog.]{\includegraphics[width=0.48\textwidth]{GLA/hStatusBeamVsSource.png}} 
	\\
	\subfloat[Nombre de runs en fonction du seuil, l'axe $z$ est le nombre d'atténuateur de la source pour les seuils correspondant.]{\includegraphics[width=0.48\textwidth]{GLA/hAttScanThresholdVsNrun.png}} 
	\hfill
	\subfloat[Valeur de l'atténuateur de la source en fonction du seuil, la couleur (le numéro) de l'axe $z$ représente le nombre de valeurs d'atténuateur prises (de runs pris avec cette valeur d'atténuateur).]{\includegraphics[width=0.48\textwidth]{GLA/hAttScanThresholdVsAtt.png}}
