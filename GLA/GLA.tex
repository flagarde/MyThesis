...
\begin{figure}[ht!]
	...
	\captionof{figure}{Cellules de lecture de taille \SI{1}{\centi\meter}$\times$\SI{1}{\centi\meter}, une cellule est encadré en vert}
	\label{cellule}
\end{figure}
...
\begin{figure}[!ht]
	\centering
	\scalebox{1.4}{\input{GLA/AttenuateurGIF.tex}}
...
\begin{figure}[ht!]
	...
	\hfill
	\subfloat[Multiplicité en fonction du seuil.]{\scalebox{0.68}{\input{GLA/Mul_200_1970.tex}}}
	\caption{Efficacité et multiplicité en fonction du seuil appliqué pour la première chambre du télescope placé à 2m de la source. La tension appliqué est de 6700V et le facteur d'atténuation de la source est de 200.}
	\label{att200}
\end{figure}

\begin{figure}[ht!]
	\centering
	\subfloat[Efficacité en fonction du seuil.]{\scalebox{0.68}{\input{GLA/Eff_22_1970.tex}}}
	\hfill
	\subfloat[Multiplicité en fonction du seuil.]{\scalebox{0.68}{\input{GLA/Mul_22_1970.tex}}}
	\caption{Efficacité et multiplicité en fonction du seuil appliqué pour la première chambre du télescope placé à 2m de la source. La tension appliqué est de 6700V et le facteur d'atténuation de la source est de 22.}
	\label{att22}
\end{figure}
...
\begin{figure}[ht!]
	\centering
	\subfloat[Efficacité en fonction du seuil.]{\scalebox{0.68}{\input{GLA/Eff_150_5500.tex}}}
	\hfill
	\subfloat[Multiplicité en fonction du seuil.]{\scalebox{0.68}{\input{GLA/Mul_150_5500.tex}}}
	\caption{Efficacité et multiplicité en fonction du seuil appliqué pour la première chambre du télescope placé à 5.5m de la source. La tension appliqué est de 6700V et le facteur d'atténuation de la source est de 150.}
	\label{att150}
\end{figure}

\begin{figure}[ht!]
	\centering
	\subfloat[Efficacité en fonction du seuil.]{\scalebox{0.68}{\input{GLA/Eff_46_5500.tex}}}
	\hfill
	\subfloat[Multiplicité en fonction du seuil.]{\scalebox{0.68}{\input{GLA/Mul_46_5500.tex}}}
	\caption{Efficacité et multiplicité en fonction du seuil appliqué pour la première chambre du télescope placé à 5.5m de la source. La tension appliqué est de 6700V et le facteur d'atténuation de la source est de 46.}
	\label{att46}
\end{figure}
...
\subsection{Vieillissement des chambres au GIF++}
...
\subsubsection{Tests en faisceaux (Mai 2016)}
...
\begin{figure}[ht!]
	\centering
	\subfloat[Chambre 1 (plus éloignées de la source).]{\includegraphics[width=.45\linewidth]{GLA/chamber1.png}}
	\hfill
	\subfloat[Chambre 2.]{\includegraphics[width=.45\linewidth]{GLA/chamber2.png}}
	\\
	\subfloat[Chambre 3.]{\includegraphics[width=.45\linewidth]{GLA/chamber3.png}}
	\hfill
	\subfloat[Chambre 4 (float glass).]{\includegraphics[width=.45\linewidth]{GLA/chamber4.png}}
	\\
	\subfloat[Chambre 5.]{\includegraphics[width=.45\linewidth]{GLA/chamber5.png}}
...
L'ouverture d'une des chambres à montré que les spacers permettant le maintient des électrodes à une distance uniforme le long de la chambres ont disparu et qu'un dépôt s'est créer sur les électrodes de la chambres (cf.fig\ref{depot})

\begin{figure}[!ht]
	\centering
	\includegraphics[width=0.8\textwidth]{GLA/depot.jpg}
	\caption{Vue intérieur d'une chambre du télescope du GIF++. Les spacers ont disparu et un dépot s'est formé sur les électrodes. }
	\label{depot}
\end{figure}
