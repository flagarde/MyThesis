...
//=========  (Thu Feb 11 12:02:16 2016) by ROOT version5.34/32
   ...
   gre->SetPoint(0,7000,0.7672);
   gre->SetPointError(0,0,0.01483);
   
   gre->SetPoint(1,6900,0.6979);
   gre->SetPointError(1,0,0.01844);
   
   gre->SetPoint(2,6800,0.5666);
   gre->SetPointError(2,0,0.01874);
   
   gre->SetPoint(3,6700,0.4488);
   gre->SetPointError(3,0,0.01135);
   
   gre->SetPoint(4,6600,0.3333);
   gre->SetPointError(4,0,0.01209);
   
   gre->SetPoint(5,7200,0.86);
   gre->SetPointError(5,0,0.015);
   
   TH1F *Graph_Graph_Graph11 = new TH1F("Graph_Graph_Graph11","",100,6500,7300);
   Graph_Graph_Graph11->SetMinimum(0);
   Graph_Graph_Graph11->SetMaximum(1.0);
   ...
   Graph_Graph_Graph11->GetXaxis()->SetTitle("HV applied (V)");
...
tex->SetNDC();
   ...
   TH1F *Graph_Graph1 = new TH1F("Graph_Graph1","",100,6500,7300);
   Graph_Graph1->SetMinimum(0);
   Graph_Graph1->SetMaximum(1.0);
   ...
   Graph_Graph1->GetXaxis()->SetTitle("HV applied (V)");
