...
\captionof{figure}{Schéma de colisions "en crabe" de paquets dans le plan transversal.}
\label{crabe}	
\end{minipagewithmarginpars}
...
\captionof{figure}{Schéma d'un protons : les quarks (vert) et anti-quarks (bleu) sont en interactions par l'intermédiaire de gluons (noir).}
\label{proton}	
\end{minipagewithmarginpars}
...
\begin{itemize}[label=$\bullet$]
 ...
 \item De nouvelles lignes de transmitions électrique vont également être installées. Ces câbles seront fait d'un matériaux supraconducteur \chemform{MgB_2} (diborure de magnésium) capable de fonctionner à haute température (\SI{20}{\kelvin}) et seront beaucoup plus stables que les supraconducteurs conventionnels. Ils permettront de porter des courants de plus de \SI{100 000}{\ampere}.
