...
\usepackage[top=2.05cm,bottom=1.1cm,left=1cm,right=5cm,marginparsep=0.50cm,marginparwidth=4.25cm,headheight=25pt,showframe]{geometry}
\usepackage{booktabs}
\usepackage{layout}
\usepackage{graphicx}
\usepackage{makecell}
