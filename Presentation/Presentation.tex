...
\end{frame}
	...
	\begin{columns}
		...
		\end{tabular} 
	\end{columns}
{\color{red} La résistivité des verres de basses résistivité est beaucoup plus élevé qu'attendue $\sim$\SI{1e10}{\ohm\centi\meter}}	
\end{block}	
...
\begin{columns}
	...
	\begin{block}{\centering Setup}
		\begin{itemize}
			...
			\includegraphics[width=1\textwidth]{ChamberFloat.png}
...
\end{frame}
	...
	\begin{block}{\centering Le prototype}
		...
		\begin{center}
			\includegraphics[width=0.75\textwidth]{PCB2.png}
		\end{center}
	\column{0.750\textwidth}
		\begin{itemize}
	...
	\end{block}
		...
		\begin{block}{\centering Résolution temporelle du PCB}
			\begin{itemize}
				...
				\begin{center}
					\scalebox{0.5}{\includetex{TDCTimeResolution}}
				\end{center}
			\end{itemize}
		\end{block}
		\end{columns}
...
\begin{frame}
			...
			\column{0.50\textwidth}
		\begin{center}
			\includegraphics[width=0.5\textwidth]{setup2017.jpg}
		\end{center}
	\end{columns}
		\end{block}
	\begin{block}{\centering Résolution temporelle T2-T1}
		\begin{center}
		\includegraphics[width=0.6\textwidth]{25p5cm.png}
		\end{center}
	\end{block}
\end{frame}
...
\begin{block}{\centering Résolution Spatiale}
	\begin{center}
	\includegraphics[width=0.8\textwidth]{MeanT_Pos.png}
	\end{center}
...
\begin{block}{\centering Lagrangien du Modèle Standard}
	...
	\begin{itemize}
		...
		\item {\only<3>{\color{red}}$\mathcal{L}_{\mathrm{Higgs}}$ Donne la masse aux bosons $Z^{0}$,$W^{\pm}$.}
		
		\item {\only<4>{\color{red}}$\mathcal{L}_{\mathrm{Yukawa}}$ Interactions entre le boson de Higgs et les fermions.}
	\end{itemize}
\end{block}
\end{frame}
