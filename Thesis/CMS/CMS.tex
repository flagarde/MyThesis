...
\begin{sidewaysfigure}
	\centering
	\begin{tikzpicture}
	\node[anchor=south west,inner sep=0] (image) at (0,0,0) {\includegraphics[width=0.75\textwidth]{CMS/Schematic.eps}};
	\begin{scope}[x={(image.south east)},y={(image.north west)}]
	%% next four lines will help you to locate the point needed by forming a grid. comment these four lines in the final picture.↓
	%\draw[help lines,xstep=.01,ystep=.01] (0,0) grid (1,1);
	%\foreach \x in {0,1,...,9} { \node [anchor=north] at (\x/10,0) {0.\x}; }
	%\foreach \y in {0,1,...,9} { \node [anchor=east] at (0,\y/10) {0.\y};}
	%% upto here↑
    \draw[o,fill=black] (0.9,0.43) -- (0.95,0.82) node[above, scale = 1.3] {\scriptsize \begin{tabular}{c}Calorimètre \\ à l'arrière \end{tabular}};
    \draw[o,fill=black] (0.385,0.632) -- (0.75,0.90) node[above, scale = 1.3] {\scriptsize  Détecteur à pixels};
    \draw[o,fill=black] (0.263,0.58) -- (0.10,1.0) node[above, scale = 1.3] {\scriptsize  Chambres à muons};
    \draw[o,fill=black] (0.283,0.58) -- (0.10,1.0) ;
    \draw[o,fill=black] (0.302,0.58) -- (0.10,1.0);
    \draw[o,fill=black] (0.315,0.58) -- (0.10,1.0);
    \draw[o,fill=black] (0.350,0.49) -- (0.15,0.20)node[below, scale = 1.3] {\scriptsize  \begin{tabular}{c}Culasse de retour \\du champ magnétique \end{tabular}};
    \draw[o,fill=black] (0.340,0.46) -- (0.15,0.20);
    \draw[o,fill=black] (0.33,0.425) -- (0.15,0.20);
    \draw[o,fill=black] (0.38,0.53) -- (0.40,0.10) node[below, scale = 1.3] {\scriptsize  \begin{tabular}{c}Aimant \\supraconducteur \end{tabular}};
    \draw[o,fill=black] (0.37,0.667) -- (0.30,0.98) node[above, scale = 1.3] {\scriptsize \begin{tabular}{c}Détecteur \\à pistes de silicium\end{tabular}};
    \draw[o,fill=black] (0.43,0.69) -- (0.58,0.88)node[above, scale = 1.3] {\scriptsize  \begin{tabular}{c}Calorimètre \\hadronique \end{tabular}};
    \draw[o,fill=black] (0.405,0.675) -- (0.48,0.98)node[above, scale = 1.3] {\scriptsize  \begin{tabular}{c}Calorimètre \\électromagnétique \end{tabular}};
    \end{scope}
	\end{tikzpicture}
	%\centering
	%\includegraphics[width=0.80\textwidth]{CMS/Schematic.eps}
	\caption{\label{cmsexploded}Vue éclatée du détecteur CMS \cite{Collaboration:1433717}.}
\end{sidewaysfigure}
\newpage
...
\begin{itemize}[label=$\bullet$]
	...
	\marginpar
	{
		...
		\captionsetup{type=figure}\caption{Un cristal de \chemform{PbWO_4}.}
		\label{crystaux}
	}
	...
	\marginpar
	{
		...
		\captionsetup{type=figure}\caption{Montage de \num{20} Super-Cristaux sur un des \textit{Dee}.}
		\label{SP}
	}
	\marginpar
	{
...
\end{itemize}
    \begin{figure}[ht!]
	\centering
	\subfloat[Une cassette contenant une chambre DT et des RPC.]{\includegraphics[width=0.40\linewidth]{CMS/DT.jpg}\label{DT}}
