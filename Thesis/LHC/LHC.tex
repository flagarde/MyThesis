...
\begin{itemize}[label=$\bullet$]
 ...
 \marginpar
 {
    \centering	
 	...
 	\captionsetup{type=figure}\caption{Photo du LINAC4.}
 	\label{linac4}
 }
...
\captionsetup{type=figure}\caption{Schéma montrant les différents types de mise à niveau nécessaires au HL-LHC \cite{High-Luminosity:2114692}.}
\label{man}	
\end{figure}
