...
\usetikzlibrary{calc,positioning,shadows.blur,decorations.pathreplacing,shapes,positioning,patterns,plotmarks,decorations.markings}
	...
	o/.style={
		...
		decoration={
			...
			mark={
				at position 0
				with {
					\draw[radius=2pt,fill=black] (0,0) circle;
				}
			}
		},
		postaction=decorate
...
\captionsetup{justification=raggedright,labelfont={color=gray,bf,small},font=small,labelsep = space}
