...
\marginpar
{
	...
	\captionof{figure}{Exemple d'effet des \num{4} interactions.}
}
...
\marginpar
{
	...
	\captionof{figure}{Exemples de diagrammes de Feynman pour le développement en série de la diffusion électron-électron.}
	\label{feyn}
}
...
\captionof{figure}{Mesures de la section efficace de production hadronique près de la résonance du $Z^0$. Les courbes indiquent les sections efficaces prédites pour deux, trois et quatre espèces de neutrinos de masses négligeables avec les couplages du Modèle Standard.}
\label{neutrinos}
\end{figure}
